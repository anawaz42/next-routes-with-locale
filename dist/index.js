...
var Route = /*#__PURE__*/function () {
  function Route(_ref2) {
    ...
    var pathToRegexpOptions = data && data.caseSensitive ? {
      sensitive: true
    } : {};
    this.name = name;
    this.locale = locale;
    ...
    this.regex = (0, _pathToRegexp["default"])(this.pattern, this.keys = [], pathToRegexpOptions);
  ...
  (0, _createClass2["default"])(Route, [{
    ...
    value: function getHref() {
      ...
      return (0, _concat["default"])(_context8 = "".concat(this.page, "?")).call(_context8, toQuerystring(_objectSpread(_objectSpread({}, params), {}, {
        nextRoute: this.name
      })));
    }
  }, {
